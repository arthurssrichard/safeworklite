...
@WebServlet(urlPatterns = {
		...
		/* Empresa */
		"/cadastro", "/insertEmpresa",

		/* Cargo */
		"/cargo/", "/cargo/cadastrar", "/cargo/store", "/cargo/edit", "/cargo/update", "/cargo/delete",

		/* Funcionario */
		"/funcionario/", "/funcionario/cadastrar", "/funcionario/store", "/funcionario/edit", "/funcionario/update",
		"/funcionario/delete", "/funcionario/examinacoes",

		/* Exame */
		"/exame/", "/exame/cadastrar", "/exame/store", "/exame/edit", "/exame/update", "/exame/delete",
...
public class Routes extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		case "/dashboard/quantExamesInadequadosCargo":
			DashboardController.quantExamesInadequadosCargo(request, response);
			break;
