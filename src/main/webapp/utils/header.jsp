<header class="bg-light p-3 shadow-sm">
    <div class="container d-flex justify-content-between align-items-center">
        <!-- Logo -->
        <div>
            <a href="/SafeWorkManagerLite/"><img alt="Safeworklite logo" src="/SafeWorkManagerLite/images/logo.png" class="img-fluid" style="max-height: 50px;"></a>
        </div>
        ...
        <nav>
            <ul class="nav">
                ...
                <li class="nav-item">
                    <a href="/SafeWorkManagerLite/funcionario/" class="nav-link text-dark">Funcionários</a>
                </li>
                <li class="nav-item">
                    <a href="/SafeWorkManagerLite/exame/" class="nav-link text-dark">Exames</a>
                </li>
                <!--<li class="nav-item">
                    <a href="/SafeWorkManagerLite/examinacao/" class="nav-link text-dark">Examinacões</a>
                </li>-->
                <li class="nav-item">
